...
const content = `# Firebase to Next.js + MongoDB Migration Guide
...
// Write markdown file
fs.writeFileSync(path.join(__dirname, 'docs', 'FIREBASE-TO-NEXTJS-MIGRATION-GUIDE.md'), content);

console.log('✅ Migration guide created: docs/FIREBASE-TO-NEXTJS-MIGRATION-GUIDE.md');
