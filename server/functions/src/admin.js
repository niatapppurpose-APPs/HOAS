 ...
 */
export const setRole = onCall(corsOptions, async (request) => {
 ...
 */
export const getUserProfile = onCall(corsOptions, async (request) => {
 ...
 * Update user profile
 */
export const updateUserProfile = onCall(corsOptions, async (request) => {
