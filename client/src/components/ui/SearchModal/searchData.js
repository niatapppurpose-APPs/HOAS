...
export const SEARCH_SCOPES = {
  student: {
    ...
    quickActions: [
      ...
      { id: 'act-sos', label: 'Trigger Emergency SOS', desc: 'Broadcast live coordinates to hostel wardens', path: '/dashboard/student/emergency', actionType: 'navigate', icon: 'ShieldAlert', category: 'Safety' },
    ],
    items: [
      ...
      { id: 'p-emergency', title: 'Emergency SOS Broadcast', subtitle: 'Real-time GPS emergency location sharing', path: '/dashboard/student/emergency', category: 'Safety', icon: 'ShieldAlert' },
  ...
  warden: {
    ...
    quickActions: [
      ...
      { id: 'act-sos-monitor', label: 'Open Live Emergency Map', desc: 'Track active SOS locations and student beacons', path: '/dashboard/warden/emergency', actionType: 'navigate', icon: 'Radio', category: 'Emergency' },
      { id: 'act-verify-fees', label: 'Verify Fee Submissions', desc: 'Review student payment proofs for your block', path: '/dashboard/warden/fee-verification', actionType: 'navigate', icon: 'CheckCircle2', category: 'Actions' },
    ],
    items: [
      ...
      { id: 'w-fees', title: 'Fee Verification Desk', subtitle: 'Confirm bank transactions and validate receipts', path: '/dashboard/warden/fee-verification', category: 'Records', icon: 'Receipt' },
      { id: 'w-emergency', title: 'Live Emergency Monitor', subtitle: 'Real-time GPS tracker with siren controls', path: '/dashboard/warden/emergency', category: 'Emergency', icon: 'ShieldAlert' },
  ...
  management: {
    ...
    quickActions: [
      ...
      { id: 'act-emergency-audit', label: 'Emergency Response Logs', desc: 'Audit incident response times and coordinates', path: '/dashboard/management/emergency', actionType: 'navigate', icon: 'Shield', category: 'Navigation' },
    ],
    items: [
      ...
      { id: 'm-fees', title: 'Fee Management & Collections', subtitle: 'Set tariffs, track pending dues, and verify audits', path: '/dashboard/management/fees', category: 'Navigation', icon: 'CreditCard' },
      ...
      { id: 'm-emergency', title: 'Emergency Response Center', subtitle: 'Campus-wide distress monitoring and warden logs', path: '/dashboard/management/emergency', category: 'Navigation', icon: 'Radio' },
  ...
  principal: {
    ...
    quickActions: [
      { id: 'act-occupancy', label: 'View Campus Occupancy KPIs', desc: 'Check block-by-block density and vacancies', path: '/dashboard/principal', actionType: 'navigate', icon: 'TrendingUp', category: 'Analytics' },
      { id: 'act-escalations', label: 'Discipline & Escalated Complaints', desc: 'Inspect serious incidents and warden escalation notes', path: '/dashboard/principal', actionType: 'navigate', icon: 'AlertTriangle', category: 'Audits' },
      { id: 'act-audit-download', label: 'Export Executive Audit', desc: 'Download complete college hostel executive summary', path: '/dashboard/principal', actionType: 'navigate', icon: 'Download', category: 'Actions' },
    ],
    items: [
      { id: 'pr-dash', title: 'Executive Overview', subtitle: 'Campus occupancy, active wardens, and overall metrics', path: '/dashboard/principal', category: 'Navigation', icon: 'Crown' },
      { id: 'pr-wardens', title: 'Chief Warden & Staff Directory', subtitle: 'Inspect active hostel supervisory personnel', path: '/dashboard/principal', category: 'Navigation', icon: 'Shield' },
      { id: 'pr-students', title: 'Student Population Registry', subtitle: 'Institutional enrollment by department and block', path: '/dashboard/principal', category: 'Navigation', icon: 'GraduationCap' },
      { id: 'pr-emergency', title: 'Safety & Incident Logs', subtitle: 'Review historical emergency records and response times', path: '/dashboard/principal', category: 'Audits', icon: 'ShieldAlert' },
    ],
  },
  ...
  owner: {
    ...
    quickActions: [
      { id: 'act-add-college', label: 'Register New College / Institution', desc: 'Provision new university tenant and assign initial admin', path: '/OwnersDashboard/colleges', actionType: 'navigate', icon: 'PlusCircle', category: 'Actions' },
      { id: 'act-sys-health', label: 'Cloud Functions & Server Health', desc: 'Inspect database latency, email function, and sockets', path: '/OwnersDashboard/system', actionType: 'navigate', icon: 'Activity', category: 'System' },
      { id: 'act-audit-logs', label: 'Global Audit Trail', desc: 'Inspect cross-institution security events and logins', path: '/OwnersDashboard/audit', actionType: 'navigate', icon: 'FileText', category: 'System' },
    ],
    items: [
      ...
      { id: 'o-colleges', title: 'Colleges & Institutions', subtitle: 'Manage registered tenant colleges and admin accounts', path: '/OwnersDashboard/colleges', category: 'Colleges', icon: 'Building' },
      ...
      { id: 'o-system', title: 'System Infrastructure', subtitle: 'Edge functions status, SMTP gateway, and push services', path: '/OwnersDashboard/system', category: 'System', icon: 'Server' },
      { id: 'o-audit', title: 'Security & Audit Logs', subtitle: 'Super-admin activity logs and security alerts', path: '/OwnersDashboard/audit', category: 'System', icon: 'Lock' },
