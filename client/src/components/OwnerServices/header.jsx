...
const Header = ({
  ...
  return (
    <header
      ...
      className={`fixed top-0 right-0 border-b backdrop-blur-xl z-30 h-16 sm:h-20 transition-all duration-300 ${
      ...
      <div className="mx-auto px-3 sm:px-6 lg:px-8 h-full">
        <div className="flex items-center justify-between h-full gap-2">
          <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
            ...
            {title && (
              <>
                <Crown
                  size={24}
                  className="text-indigo-500 hidden sm:block flex-shrink-0"
                />
                <h1
                  style={{ color: "var(--text-primary)" }}
                  className="text-sm sm:text-lg font-bold truncate pr-2"
                >
                  {title}
                </h1>
              </>
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
            ...
            {/* Logout Button */}
            <div id="tour-logout" className="hidden flex-shrink-0 lg:flex">
