...
const Sidebar = ({ isCollapsed, setIsCollapsed }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      label: "Notifications",
       icon: Bell,
      path: "/OwnersDashboard/notifications",
    ...
    <>
      <div className="hidden lg:block">
        ...
        >
          ...
          >
            <div
              className={`flex items-center gap-3 transition-all duration-300 ${!showContent ? "lg:justify-center lg:w-full" : ""}`}
            >
              <button
              ...
              <div
                className={`flex flex-col transition-all duration-300 origin-left ${!showContent ? "lg:hidden opacity-0 w-0 scale-95" : "opacity-100 w-auto scale-100"}`}
              >
                <h1
            ...
            <div className="flex items-center gap-2 ">
              ...
              <button
                ...
                className={`hidden lg:flex items-center justify-center cursor-pointer w-8 h-8 rounded-lg border-2 transition-all duration-200 ${
                  !showContent ? "opacity-0 pointer-events-none" : "opacity-100"
                } ${
                  isPinned ? "bg-indigo-600 text-white" : "hover:text-white"
                }`}
                style={{
              ...
              >
                ...
                >
                  <Avatar
                    ...
                    email={
                      ownerProfile?.email || userData?.email || user?.email
                    }
                    name={
