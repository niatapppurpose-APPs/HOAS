...
// Global Delete Modal Component that uses ModalContext
const GlobalDeleteModal = () => {
  const { deleteModal, isDeleting, closeDeleteModal, confirmDelete } = useModal();
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-2xl p-6 max-w-md w-full shadow-2xl">
        ...
        <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-4 mb-6">
          ...
          <ul className="text-red-300/80 text-sm space-y-1">
            ...
            <li>• {deleteModal.wardenCount} warden(s) under this college</li>
            <li>• {deleteModal.studentCount} student(s) under this college</li>
          </ul>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={isDeleting}
            className="flex-1 px-4 py-2.5 rounded-lg bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400 text-white font-medium transition-all disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {isDeleting ? (
              <>
