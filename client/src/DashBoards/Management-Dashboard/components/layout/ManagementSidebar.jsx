  ...
  const menuItems = [
    {
      ...
      tourId: "mgmt-tour-nav-dashboard",
    },
    {
      id: "wardens",
      label: "Wardens",
      icon: Building2,
      path: "/dashboard/management/wardens",
      tourId: "mgmt-tour-nav-wardens",
    },
    {
      id: "students",
      label: "Students",
      ...
      tourId: "mgmt-tour-nav-students",
    },
    {
      id: "hostels",
      label: "Hostels",
      icon: Home,
      path: "/dashboard/management/hostels",
      tourId: "mgmt-tour-nav-hostels",
    },
    {
      id: "complaints",
      label: "Complaints",
      icon: MessageSquare,
      path: "/dashboard/management/complaints",
      tourId: "mgmt-tour-nav-complaints",
    },
    {
      id: "analytics",
      label: "Analytics",
      ...
      tourId: "mgmt-tour-nav-analytics",
    },
    {
      id: "emergency-location",
      label: "Emergency Location",
      icon: ShieldAlert,
      path: "/dashboard/management/emergency-location",
      tourId: "mgmt-tour-nav-emergency-location",
    },
    {
      id: "reports",
      label: "Reports",
  ...
  const bottomMenuItems = [
    {
      ...
      tourId: "mgmt-tour-nav-settings",
    },
    {
      id: "help",
      label: "Help & Support",
      icon: HelpCircle,
      path: "/dashboard/management/help",
      tourId: "mgmt-tour-nav-help",
    },
  ];
      ...
      <div className="hidden lg:block">
        ...
        >
          ...
          >
            ...
            <div
              className={`flex items-center gap-3 min-w-0 flex-1 transition-all duration-300 ${!showContent ? "lg:justify-center lg:flex-none" : ""}`}
            >
              <button
              ...
              <div
                className={`flex flex-col min-w-0 overflow-hidden transition-all duration-300 origin-left ${
                  !showContent
                    ? "lg:hidden opacity-0 w-0 scale-95"
            ...
            <div className="flex items-center gap-1 flex-shrink-0 ml-1">
              ...
              >
                <Pin
                  className={`w-4 h-4 transition-transform ${isPinned ? "rotate-60" : ""}`}
                />
              </button>
          ...
          <nav className="flex flex-col h-[calc(100%-5rem)] py-4">
            ...
            >
              ...
              >
                <div
                  className={`flex items-center ${showContent ? "gap-3" : "justify-center"}`}
                >
                  <Avatar
