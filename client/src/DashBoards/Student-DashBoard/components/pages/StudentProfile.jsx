...
const StudentProfile = () => {
  ...
  const collegeLocation =
    managementData?.collegeLocation ||
  ...
  useEffect(() => {
    setFormData({
      fullName:
        userData?.fullName || userData?.displayName || user?.displayName || "",
    ...
    >
      <div className=" fixed right-10 top-5">
        ...
        <div className="flex justify-end items-center p-4">
          <div
            className="p-1 rounded-xl shadow-lg backdrop-blur-md"
            style={{
          ...
          <div className="px-5 sm:px-6 pb-6">
            <div className="flex flex-col sm:flex-row sm:items-end gap-4 mb-4">
              <div className="relative flex-shrink-0 -mt-10 sm:-mt-14">
                <div
                  className="w-16 h-16 sm:w-28 sm:h-28 rounded-xl sm:rounded-2xl overflow-hidden border-2 sm:border-4 shadow-xl"
              ...
              <div className="flex-1 min-w-0 sm:pb-1">
                ...
                <p
                  className="text-xs sm:text-sm mt-0.5 font-medium opacity-80"
                  style={{ color: mutedColor }}
                >
                  {collegeLocation}
                </p>
                <span
                  className="inline-flex items-center gap-1 mt-2 px-3 py-1 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-wider"
                  style={{
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  { icon: Building2, label: "College", value: collegeName },
                  {
                    icon: BookOpen,
                    label: "Student ID",
                    value: userData?.studentId || userData?.rollNumber || "—",
                  },
                  {
                    icon: Home,
                    label: "Room Number",
                    value: userData?.roomNumber || userData?.hostelRoom || "—",
                  },
                  {
                    icon: BookOpen,
                    label: "Course",
