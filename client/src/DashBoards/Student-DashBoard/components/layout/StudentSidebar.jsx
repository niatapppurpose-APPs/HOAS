  ...
  const menuItems = [
    {
      ...
      tourId: "student-tour-nav-dashboard",
    },
    {
      id: "emergency-location",
      label: "Emergency Location",
      icon: ShieldAlert,
      path: "/dashboard/student/emergency-location",
      tourId: "student-tour-nav-emergency-location",
    },
    {
      id: "complaints",
      label: "Complaints",
      ...
      tourId: "student-tour-nav-complaints",
    },
    {
      id: "fees",
      label: "Fee Status",
  ...
  const bottomMenuItems = [
    {
      ...
      tourId: "student-tour-nav-settings",
    },
    {
      id: "help",
      label: "Help & Support",
  ...
  return (
    <>
      ...
      <MobileBottomNav
        ...
        activeId={activeItem}
        accentVar="var(--student-accent)"
        accentVar2="var(--student-accent-2)"
