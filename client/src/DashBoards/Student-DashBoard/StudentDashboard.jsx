      ...
      <div className="pt-20 md:pt-24 px-4 sm:px-6 lg:px-8 pb-4">
              ...
              <div className="flex gap-4 md:gap-8">
                <div className="text-center">
                  <div className="p-3 md:p-5 rounded-xl md:rounded-2xl bg-blue-500/10 border border-blue-500/20 shadow-inner">
                    <p className="text-xl md:text-2xl font-black text-blue-500 leading-none">
                      {pendingCount}
                    </p>
                    <p className="mt-1 md:mt-1.5 text-[10px] md:text-xs font-bold text-blue-500 uppercase tracking-widest">
                      Active Issues
                    </p>
                  </div>
                </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-8 space-y-6 md:space-y-8">
            ...
            >
              {quickActions.map((action, idx) => (
                ...
                >
                  <div
                    className={`p-3 md:p-4 rounded-xl md:rounded-2xl bg-${action.color}-500/10 text-${action.color}-600 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300`}
                  >
            ...
            >
              ...
              >
                <div>
                  ...
                  <p
                    className="text-[10px] md:text-xs font-bold mt-1 opacity-60 uppercase tracking-widest"
                    style={{ color: "var(--text-muted)" }}
                  >
                    Latest updates on your filed complaints
                  </p>
                </div>
                <button
                  onClick={() => navigate("complaints")}
                  className="group flex items-center gap-1.5 md:gap-2 text-[10px] md:text-xs font-black uppercase tracking-widest text-blue-500 hover:gap-3 transition-all"
                >
              ...
              <div
                className="divide-y max-h-[380px] overflow-y-auto student-scrollbar"
              ...
              >
                {complaintsLoading ? (
                  <div className="p-10 md:p-12 text-center">
                    ...
                    <p
                      className="mt-3 md:mt-4 text-[10px] md:text-xs font-bold uppercase tracking-widest animate-pulse"
                      style={{ color: "var(--text-muted)" }}
                    >
                  ...
                  complaints.map((c) => (
                    <div
                      key={c.id}
                      className="p-4 md:p-5 flex items-center gap-3 md:gap-4 hover:bg-blue-500/5 transition-all cursor-pointer group"
                      onClick={() => navigate("complaints")}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between">
                          <p
                            className="text-sm md:text-base font-bold truncate group-hover:text-blue-600 transition-colors"
                            style={{ color: "var(--text-primary)" }}
                          >
                            {c.title}
                          </p>
          ...
          <div className="lg:col-span-4 space-y-6 md:space-y-8">
            {/* Profile Info Card */}
            <div
              id="student-tour-info"
              className="rounded-[1.25rem] md:rounded-[1.5rem] border p-6 md:p-4 shadow-sm"
              style={{
                backgroundColor: "var(--bg-card)",
                borderColor: "var(--border-primary)",
              }}
