...
const WardenProfile = () => {
    ...
    // But userData.collegeLogo may also be set — use it directly
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="rounded-2xl overflow-hidden shadow-xl"
                    ...
                    <div className="h-32 sm:h-40 relative"
                        style={{ background: "linear-gradient(135deg,#f97316,#f59e0b,#ea580c)" }}>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-end gap-4 -mt-12 sm:-mt-14 mb-4">
                            ...
                            <div className="flex-1 min-w-0 sm:pb-2">
                                ...
                                <span className="inline-flex items-center gap-1 mt-2 px-3 py-1 rounded-full text-xs font-medium"
                                    ...
                                    <Shield className="w-3 h-3" /> Warden Portal
                                </span>
                            </div>
                        </div>
