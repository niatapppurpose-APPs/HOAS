  ...
  return (
    <>
      ...
      <div className="pt-20 md:pt-24 px-4 sm:px-6 lg:px-8 pb-6 md:pb-0">
        {/* Welcome Banner */}
        <div
          id="warden-tour-welcome"
          className="relative mb-6 md:mb-8 overflow-hidden rounded-[1.5rem] md:rounded-[2rem] p-5 md:p-10 border shadow-2xl transition-all hover:shadow-orange-500/10"
          style={{
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
            <div className="text-center md:text-left">
              ...
              <div className="mt-6 flex flex-wrap gap-3 justify-center md:justify-start">
                <Link
                  to="complaints"
                  className="px-4 md:px-5 py-2 md:py-2.5 rounded-xl bg-orange-500 text-white font-bold text-xs md:text-sm shadow-lg shadow-orange-500/30 hover:scale-105 transition-transform flex items-center gap-2"
                >
                  <MessageSquare size={14} className="md:w-4 md:h-4" /> Manage
                  Complaints
                </Link>
                <button
                  onClick={() => navigate("profile")}
                  className="px-4 md:px-5 py-2 md:py-2.5 rounded-xl border font-bold text-xs md:text-sm hover:bg-orange-500/5 transition-all flex items-center gap-2"
                  style={{
                    borderColor: "var(--border-primary)",
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-end gap-4 md:gap-8">
              ...
              >
                ...
                <p
                  className="mt-1 text-[9px] md:text-xs font-bold uppercase tracking-widest opacity-60"
                  style={{ color: "var(--text-primary)" }}
                >
              ...
              <div className="flex gap-4 md:gap-8">
                <div className="text-center">
                  <div className="p-3 md:p-5 rounded-xl md:rounded-2xl bg-amber-500/10 border border-amber-500/20 shadow-inner">
                    <p className="text-xl md:text-2xl font-black text-amber-500 leading-none">
                      {pendingCount}
                    </p>
                    <p className="mt-1 md:mt-1.5 text-[10px] md:text-xs font-bold text-amber-500">
                      Issues
                    </p>
                  </div>
                </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-8 space-y-6 md:y-8">
            ...
            >
              {quickActions.map((action, idx) => (
                ...
                >
                  <div
                    className={`p-3 md:p-4 rounded-xl md:rounded-2xl bg-${action.color}-500/10 text-${action.color}-500 group-hover:bg-${action.color}-500  transition-all duration-300`}
                  >
                    <action.icon className="w-5 h-5 md:w-6 md:h-6" />
                  </div>
                  <h3
                    className="mt-3 md:mt-4 text-xs md:text-sm font-bold"
                    style={{ color: "var(--text-primary)" }}
                  >
                    {action.title}
                  </h3>
            ...
            <div className="p-5">
              <div
                id="warden-tour-activity"
                className="rounded-[1.25rem] md:rounded-[1.5rem] border overflow-hidden shadow-sm"
                style={{
                  backgroundColor: "var(--bg-card)",
                  borderColor: "var(--border-primary)",
                }}
              >
                <div
                  className="p-5 md:p-8 border-b flex items-center justify-between"
                  style={{
                    borderColor: "var(--border-primary)",
                    backgroundColor: "var(--bg-tertiary)",
                  }}
                >
                  <div>
                    ...
                    <p
                      className="text-xs md:text-sm font-medium mt-1 opacity-60"
                      style={{ color: "var(--text-muted)" }}
                    >
                      Latest updates from students
                    </p>
                  </div>
                  <Link
                    to="complaints"
                    className="group flex items-center gap-1.5 md:gap-2 text-xs md:text-sm font-bold text-orange-500 hover:gap-3 transition-all"
                  >
                    <span className="hidden sm:inline">View Service Hub</span>{" "}
                    <ArrowRight size={14} className="md:w-4 md:h-4" />
                  </Link>
                </div>

                <div
                  className="divide-y max-h-[320px] overflow-y-auto warden-scrollbar"
                ...
                >
                  {loading ? (
                    <div className="p-10 md:p-12 text-center">
                      ...
                      <p
                        className="mt-3 md:mt-4 text-xs md:text-sm font-medium animate-pulse"
                        style={{ color: "var(--text-muted)" }}
                      >
                        Syncing data...
                      </p>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            <p
                              className="text-sm md:text-base font-bold truncate group-hover:text-orange-500 transition-colors"
                              style={{ color: "var(--text-primary)" }}
                            >
                              {c.title}
                            </p>
                        ...
                        <ChevronRight
                          className="hidden sm:block w-4 h-4 md:w-5 md:h-5 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all"
                          style={{ color: "var(--text-muted)" }}
                        />
                      </div>
                    ))
          ...
          <div className="lg:col-span-4 space-y-6 md:y-8 relative lg:top-15">
            ...
            <div
              id="warden-tour-info"
              className="rounded-[1.25rem] md:rounded-[1.5rem] border p-6 md:p-8 shadow-sm"
              style={{
                backgroundColor: "var(--bg-card)",
                borderColor: "var(--border-primary)",
              }}
            >
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 rounded-full md:w-24 md:h-24 p-1 mb-4 md:mb-6">
              ...
              <div className="mt-6 md:mt-8 space-y-2 md:space-y-3">
                <div
                  className="flex items-center gap-3 md:gap-4 p-3 md:p-4 rounded-xl md:rounded-2xl transition-colors hover:bg-orange-500/5"
                  style={{ backgroundColor: "var(--bg-tertiary)" }}
                >
                  <Phone className="w-4 h-4 md:w-5 md:h-5 text-orange-500" />
                  <div className="min-w-0">
                    <p
                      className="text-[9px] md:text-[10px] font-black uppercase tracking-widest opacity-50"
                      style={{ color: "var(--text-muted)" }}
                    >
                      Contact
                    </p>
